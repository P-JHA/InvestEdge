    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            {/* <img src="media/images/12.jpeg" style={{ width: "50%" }} /> */}
            <img
            ...
            ></span>
            <p>
              &copy; 2010 - 2024, Not InvestEdge Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col">
            <p>Company</p>
            ...
            <br />
            <a href="" style={{ textDecoration: "none" }}>InvestEdge.tech</a>
            <br />
            <a href="" style={{ textDecoration: "none" }}>Press & media</a>
            <br />
            <a href="" style={{ textDecoration: "none" }}>InvestEdge cares (CSR)</a>
            <br />
          </div>
          <div className="col">
            <p>Support</p>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            InvestEdge Broking Ltd.: Member of NSE​ &​ BSE – SEBI Registration no.:
            INZ000031633 CDSL: Depository services through InvestEdge Securities
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through InvestEdge Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
            no.: INZ000038238 Registered Address: InvestEdge Broking Ltd.,
            #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School,
            J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any
            complaints pertaining to securities broking please write to
            complaints@investedge.com, for DP related to dp@investedge.com. Please
          ...
          <p>
            ...
            claiming to be part of InvestEdge and offering such services, please
